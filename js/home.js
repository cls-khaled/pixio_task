...
// ##### Manipulations #####
// for [collection text] rotation animation  
collectionText.innerHTML = collectionText.innerText.split('').map(
    (char , index) => `<span style="transform:rotate(${index * 14.5}deg)">${char}</span>`
).join('');
